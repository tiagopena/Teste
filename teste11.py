...
topologia_01_do_smartlog = cria_topologia_01_do_smartlog(topologia_original_smart)
print(topologia_01_do_smartlog)
#def cria_topologia_02_do_smartlog (topologia_01_do_smartlog):
##    cidade = []
#    for item01 in topologia_01_do_smartlog:
